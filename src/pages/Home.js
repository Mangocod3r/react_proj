          ...
          <img alt="image" src="public/playground_assets/curved6-1500h.jpg" className="home-image" />7
            ...
            <div data-role="MobileMenu" className="header-mobile-menu">
              <div className="header-top">
                <a href="index.html" className="header-navlink4 Large">
                  Akova
                </a>
              ...
              <div className="header-mid">
                <div className="header-menu1">
                  <a href="index.html" className="header-navlink5 Large">Home</a>
                  <a href="profile.html" className="header-navlink6 Large">Profile</a>
          ...
          <div className="home-hero">
            <div className="home-container01">
              <div className="home-card">
                <h1 className="home-text HeadingOne">Akova</h1>
                <h1 className="home-text01 HeadingOne">Choose the best</h1>
                <span className="home-text02">
                  Because here you can go beyond the limits of yourself by
                  exploring until you find what you want
                </span>
            ...
            <div className="home-container12">
              <div className="home-container13">
                <div className="home-container14">
                  <h2 className="home-text21 HeadingOne">Work with others</h2>
                  <p className="home-text22 Lead">
                    Whatever your qualification is - we got you!
                  </p>
                  <p className="home-text23 Body">
          ...
          <section className="home-contaier">
            <div className="home-container30">
              ...
              <h2 className="home-text27 HeadingTwo">
                <span className="home-text28">Beware The Components</span>
              </h2>
              <h3 className="home-text29 HeadingTwo">
                <span className="home-text30">How To Handle Them</span>
                <br />
              </h3>
            ...
            <div className="home-container32">
              <div className="home-container33">
                ...
                <div className="home-container35">
                  <svg viewBox="0 0 987.4285714285713 1024" className="home-icon2">
                    <path d="M438.857 508.571l312 312c-79.429 80.571-190.286 130.286-312 130.286-242.286 0-438.857-196.571-438.857-438.857s196.571-438.857 438.857-438.857v435.429zM545.714 512h441.714c0 121.714-49.714 232.571-130.286 312zM950.857 438.857h-438.857v-438.857c242.286 0 438.857 196.571 438.857 438.857z" />
                  </svg>
                  <h1 className="home-text32 HeadingOne">Search and Discover!</h1>
              ...
              <div className="home-container36">
                <div className="list-item-container">
                  <h5 className="list-item-text HeadingThree">
