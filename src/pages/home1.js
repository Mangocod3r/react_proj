  ...
  return (
    ...
    <div className="home-container">
        ...
        <div className="home-container01">
          <div className="home-card">
            ...
            <span className="home-text02">
              Because here you can go beyond the limits of yourself by exploring
      ...
      <section className="home-features">
        <FeatureCard
          text="Choose the best platform for your next product."
          title="Components"
          image_src="/playground_assets/cube1.svg"
        ></FeatureCard>
        <FeatureCard
          text="Get the latest project ideas and turn it into reality"
          image_src="/playground_assets/person1.svg"
        ></FeatureCard>
        <FeatureCard
          text="Make your idea easier to maintain using variables."
          title="Less Code"
          image_src="/playground_assets/rocket1.svg"
        ></FeatureCard>
        <FeatureCard
          text="This system is fully supported on any device."
        ...
        <div className="home-container37">
          ...
          <div className="home-container39">
            ...
            <div className="home-container41">
              ...
              <span className="home-text35">Students</span>
              <OutlineBlackButton button="get started"></OutlineBlackButton>
            </div>
          </div>
        </div>
